...
# Funnel Content — Cat Halloween

AI video generator funnel: cat owner uploads a photo of their cat, AI turns it into a Halloween costume video. 12-screen flow, matching the Figma flow board (hooks → name → style → upload → social proof → generation → lucky wheel → email → paywall). Copy kept short to fit mobile screens.

---

## 1. Ob1 — Welcome Hook A
**Purpose:** Grab attention with an emotional "before" state and introduce the promise.
**Headline:** Your cat, now a vampire
**Body:** Turn a photo into a spooky video.
**Visual:** Dark background, rounded card with collage of cats in costumes, trophy badge top bar, purple-to-orange gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping cat photos (before / costumed), purple gradient CTA button.
**CTA:** Continue

## 3. Ob3 — Welcome Hook C
**Purpose:** Set expectation for time savings / ease.
**Headline:** Ready before Halloween night
**Body:** One photo. One spooky video.
**Visual:** Dark background, rounded card with single cat photo, orange candlelight glow, purple gradient CTA button.
**CTA:** Continue
...
**Body:** This sets {{cat_name}}'s costume look.
**Options:**
- 🧛 Vampire
- 🧙 Witch
- 🧟 Zombie
...
**Headline:** 1.4M+ costume videos created
**Body:** Loved by cat owners everywhere.
**Visual:** Huge bold stat number on black, press logo row below (The Dodo, Forbes, BuzzFeed-style placements).
**CTA:** Continue

## 9. Video Generation (Loading)
**Purpose:** Build anticipation while AI "works," reduce perceived wait.
**Headline:** Conjuring {{cat_name}}'s video...
...
- Preparing {{cat_name}}'s Halloween video...
- Almost ready — your first preview awaits
**Visual:** Hero image of {{cat_name}} in costume filling the top half, glowing orange ring animating over it; four progress rows beneath, each with label, % counter, checkmark and orange progress bar.
**CTA:** (auto-advances)
