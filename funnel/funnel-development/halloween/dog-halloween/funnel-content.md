...
**Headline:** Your dog, now a werewolf
**Body:** Turn a photo into a spooky video.
**Visual:** Dark background, rounded card with collage of dogs in costumes, trophy badge top bar, purple-to-orange gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping dog photos (before / costumed), purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with single dog photo, orange jack-o'-lantern glow, purple gradient CTA button.
**CTA:** Continue
...
**Body:** This sets {{dog_name}}'s costume look.
**Options:**
- 🐺 Werewolf
- 🧛 Vampire
- 🧟 Zombie
...
**Headline:** 1.6M+ costume videos created
...
**Headline:** Conjuring {{dog_name}}'s video...
...
- Preparing {{dog_name}}'s Halloween video...
- Almost ready — your first preview awaits
**Visual:** Hero image of {{dog_name}} in costume filling the top half, glowing orange ring animating over it; four progress rows beneath, each with label, % counter, checkmark and orange progress bar.
**CTA:** (auto-advances)
