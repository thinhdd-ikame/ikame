...
**Headline:** You two, now vampires
**Body:** Turn a photo into a spooky video.
**Visual:** Dark background, rounded card with collage of couples in matching costumes, trophy badge top bar, purple-to-orange gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping couple photos (before / costumed), purple gradient CTA button.
**CTA:** Continue

## 3. Ob3 — Welcome Hook C
**Purpose:** Set expectation for time savings / ease.
**Headline:** Ready before Halloween night
**Body:** One photo. One spooky duo.
**Visual:** Dark background, rounded card with single couple photo, orange candlelight glow, purple gradient CTA button.
**CTA:** Continue
...
**Body:** This sets {{partner_name}}'s costume look.
**Options:**
- 🧛 Vampire duo
- 🧟 Zombie pair
- 👻 Ghost couple
...
**Headline:** 1.3M+ costume videos created
**Body:** Loved by couples everywhere.
**Visual:** Huge bold stat number on black, press logo row below (Cosmopolitan, Brides, Refinery29-style placements).
**CTA:** Continue

## 9. Video Generation (Loading)
**Purpose:** Build anticipation while AI "works," reduce perceived wait.
**Headline:** Conjuring {{partner_name}}'s video...
...
- Preparing {{partner_name}}'s Halloween video...
- Almost ready — your first preview awaits
**Visual:** Hero image of the couple in costume filling the top half, glowing orange ring animating over it; four progress rows beneath, each with label, % counter, checkmark and orange progress bar.
**CTA:** (auto-advances)
