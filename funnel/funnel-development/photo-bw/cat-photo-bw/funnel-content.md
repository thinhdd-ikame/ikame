...
**Headline:** Your cat in black & white
**Body:** Turn a photo into a timeless portrait.
**Visual:** Dark background, rounded card with B&W cat portrait collage, trophy badge top bar, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping cat photos — color before, B&W after, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with single high-contrast B&W cat portrait, purple gradient CTA button.
**CTA:** Continue
...
**Body:** Loved by cat owners everywhere.
**Visual:** Huge bold stat number on black, press logo row below (The Dodo, Catster, Rolling Stone-style placements).
**CTA:** Continue

## 9. Photo Generation (Loading)
**Purpose:** Build anticipation while AI "works," reduce perceived wait.
**Headline:** Creating {{cat_name}}'s portrait...
...
**Headline:** Unlock {{cat_name}}'s portrait
**Body:** Pick a plan.
