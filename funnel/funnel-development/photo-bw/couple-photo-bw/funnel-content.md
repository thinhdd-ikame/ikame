...
**Headline:** You two in black & white
**Body:** Turn a photo into a timeless portrait.
**Visual:** Dark background, rounded card with B&W couple portrait collage, trophy badge top bar, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping couple photos — color before, B&W after, purple gradient CTA button.
**CTA:** Continue

## 3. Ob3 — Welcome Hook C
**Purpose:** Set expectation for time savings / ease.
**Headline:** Ready in under a minute
**Body:** One photo. One timeless portrait.
**Visual:** Dark background, rounded card with single soft-lit B&W couple portrait, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Huge bold stat number on black, press logo row below (Brides, Vogue, Cosmopolitan-style placements).
**CTA:** Continue

## 9. Photo Generation (Loading)
**Purpose:** Build anticipation while AI "works," reduce perceived wait.
**Headline:** Creating {{partner_name}}'s portrait...
...
- Preparing {{partner_name}}'s portrait...
...
**Headline:** Unlock {{partner_name}}'s portrait
**Body:** Pick a plan.
