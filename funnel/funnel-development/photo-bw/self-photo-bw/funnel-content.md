...
# Funnel Content — Self Photo B&W

AI photo generator funnel: user uploads a selfie of themselves, AI turns it into a timeless black & white portrait. 12-screen flow, matching the Figma flow board (hooks → name → style → upload → social proof → generation → lucky wheel → email → paywall). Copy kept short to fit mobile screens.

---

## 1. Ob1 — Welcome Hook A
**Purpose:** Grab attention with an emotional "before" state and introduce the promise.
**Headline:** You in black & white
**Body:** Turn a selfie into a timeless portrait.
**Visual:** Dark background, rounded card with B&W headshot collage, trophy badge top bar, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Dark background, rounded card with two overlapping selfies — color before, B&W after, purple gradient CTA button.
**CTA:** Continue

## 3. Ob3 — Welcome Hook C
**Purpose:** Set expectation for time savings / ease.
**Headline:** Ready in under a minute
**Body:** One selfie. One studio portrait.
**Visual:** Dark background, rounded card with single high-contrast B&W headshot, purple gradient CTA button.
**CTA:** Continue
...
**Visual:** Huge bold stat number on black, press logo row below (Forbes, GQ, Vogue-style placements).
**CTA:** Continue

## 9. Photo Generation (Loading)
**Purpose:** Build anticipation while AI "works," reduce perceived wait.
**Headline:** Creating {{user_name}}'s portrait...
...
- Preparing {{user_name}}'s portrait...
...
**Headline:** Unlock {{user_name}}'s portrait
**Body:** Pick a plan.
