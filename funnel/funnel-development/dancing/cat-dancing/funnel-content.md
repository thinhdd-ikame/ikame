...
AI video generator funnel: cat owner uploads a photo of their cat, AI turns it into a fun dancing video. 12-screen flow, modeled on the reference funnel (hook → personalization quiz → generation → social proof → paywall → payment → success). Copy kept short to fit mobile screens.
...
**Body:** Upload a photo, answer 2 questions, done.
...
**Body:** Analyzing → animating → rendering
**Visual:** Mosaic grid of cat photos animating, progress bar, app logo appears as it completes.
**CTA:** (auto-advances)
...
**Headline:** {{cat_name}}'s video is ready!
**Body:** Sign up to watch it.
**Visual:** Blurred video thumbnail of the cat filling the screen, dark gradient overlay, CTA pinned at bottom.
**CTA:** Continue
...
**Body:** Download or share it.
**Visual:** App logo centered on dark background, short confirmation text, single CTA button.
